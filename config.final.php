<?php
/**
 * FINAL PRODUCTION CONFIGURATION for InfinityFree
 */
session_start();

// Database credentials
define('DB_HOST', 'sql305.infinityfree.com');
define('DB_USER', 'if0_41683784');
define('DB_PASS', 'qsit4FaptR738aF');
define('DB_NAME', 'if0_41683784_YOUR_DB_NAME'); // REPLACE 'YOUR_DB_NAME' with your full DB name from InfinityFree

// Site URL
define('SITE_NAME', 'Timnah Schools');
define('SITE_URL', 'http://YOUR_SUBDOMAIN.infinityfreeapp.com'); // REPLACE with your actual website link
...
function getDB() {
    ...
    if ($conn === null) {
        try {
            ...
            die("Database connection failed. Check your DB_NAME and Credentials.");
        }
    }
    return $conn;
}
